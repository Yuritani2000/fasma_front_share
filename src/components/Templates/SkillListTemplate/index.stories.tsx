...
_SkillListTemplate.args = {
  ...
  skills:[
      {"id":1,"name":"Proccesing","category":"Programing","tags":["programing","proccessing","1st grade"],
      ...
      {"id":2,"name":"Proccesing","category":"Programing","tags":["programing","proccessing","1st grade"],
      "description":"一学年のProccessingはSで通過しました。Javaの知識もあるので弾幕ゲームを作る際に必要なクラスについても教えることができます。",
